...
import { Shield, Trash2, Edit, UserCheck, UserX, Plus, Mail, Clock, Search, Filter, Activity } from "lucide-react";
...
export function UsersTable({ initialUsers, canEditUsers, currentUserEmail }: UsersTableProps) {
  const { toast } = useToast();
  const router = useRouter();
